				...
				<div className="fugu--newslatter-wrap">
					<div className="fugu--section-title">
						<div className="fugu--default-content content-sm">
							<h2>Subscribe to get the latest news updates about IDverse</h2>
							<p>
								Get regular updates about interesting & secret upcoming IDverse NFT projects & opportunities that are
