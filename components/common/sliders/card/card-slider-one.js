			...
			<div className="container">
				<div className="fugu--section-title">
					<div className="fugu--default-content content-sm">
						<h2>This weeks trending achievements</h2>
						<p>
							Some of the trending achievements by students in IDverse shared with recruiters to showcase their portfolio with web3 world.
						</p>
					</div>
				</div>
